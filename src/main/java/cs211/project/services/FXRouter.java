...
public final class FXRouter {
    ...
    public static void goTo(String routeLabel) throws IOException {
        AllCollection.getInstance().setCurrentPage(routeLabel);
    ...
    private static void loadNewRoute(RouteScene route) throws IOException {
        ...
        if (AllCollection.getInstance().getCurrentUser() != null && !(AllCollection.getInstance().getCurrentPage() != null && AllCollection.getInstance().getCurrentPage().equals("log-in"))) {
            AllCollection.getInstance().getCurrentUser().getTheme().setScene(window.getScene());
        }
        window.show();
